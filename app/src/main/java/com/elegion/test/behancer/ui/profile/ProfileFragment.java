...
public class ProfileFragment extends PresenterFragment<ProfilePresenter> implements Refreshable, ProfileView {
    ...
    //TODO создать custom scope модуль, компонент и зависимость для ProfilePresenter
...
//    Picasso picasso;
    ...
    public void onAttach(Context context) {
        ...
        PresenterComponent component = AppDelegate.getInstance().plusPresenterComponent(this);
...
//        AppDelegate.getProfileComponent(mUsername, this).inject(this);
//        DaggerPresenterComponent.builder().appComponent(AppDelegate.getAppComponent()).presenterModule(new PresenterModule()).build();
//        AppDelegate.getAppComponent().inject(this);
//        AppDelegate.getAppComponent().inject(this);
        mPresenter.setView(this);
//        AppDelegate.getAppComponent().createProfileComponent(new ProfileModule(mUsername, this)).inject(this);
        showProfile();
        onRefreshData();
